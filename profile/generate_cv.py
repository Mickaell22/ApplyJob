...
Uso: .venv/bin/python3 profile/generate_cv_harvard.py
Produce: profile/cv_harvard_es.docx  y  profile/cv_harvard_en.docx
"""
...
def build_es():
    ...
    add_role_line(doc, "Ingeniería en Sistemas de Información — 9no semestre", "2021 – presente")
    add_body(doc, "Promedio académico: 8.98 / 10  (escala 0–10, aprobación desde 7)")

    add_org_line(doc, "Google / Coursera", "En línea", space_before=4)
    add_role_line(doc, "Certificado Profesional de Ciberseguridad", "2025")

    add_org_line(doc, "Google / Coursera", "En línea", space_before=4)
    add_role_line(doc, "Certificado Profesional de UX Design", "2025 – en curso")

    # ── EXPERIENCIA ──
    add_section(doc, "Experiencia")

    add_org_line(doc, "EcuaInventario", "Guayaquil, Ecuador")
    add_role_line(doc, "Co-fundador & Desarrollador Fullstack", "2024 – presente")
    ...
    add_role_line(doc, "Desarrollador Fullstack", "2023 – presente")
    ...
    add_role_line(doc, "Practicante de Desarrollo de Software", "2025  (6 meses)")
    ...
    add_role_line(doc, "Pipeline automatizado de postulación laboral con IA", "Python · Playwright · LLMs")
    add_bullet(doc, "Automaticé scraping de 7 job boards, matching de ofertas contra perfil y generación de cartas personalizadas con IA.")
    add_bullet(doc, "Implementé auto-postulación en ATS (Workable, Greenhouse, GetOnBrd) con Playwright headless.")
    ...
    add_skills_line(doc, "Ciberseguridad", "Kali Linux (aprendizaje activo), Nmap, Wireshark")
...
def build_en():
    ...
    add_body(doc, "GPA: 8.98 / 10  (grading system: 0–10, minimum passing grade: 7)")

    add_org_line(doc, "Google / Coursera", "Online", space_before=4)
    add_role_line(doc, "Professional Certificate in Cybersecurity", "2025")

    add_org_line(doc, "Google / Coursera", "Online", space_before=4)
    add_role_line(doc, "Professional Certificate in UX Design", "2025 – in progress")

    # ── EXPERIENCE ──
    add_section(doc, "Experience")

    add_org_line(doc, "EcuaInventario", "Guayaquil, Ecuador")
    add_role_line(doc, "Co-founder & Fullstack Developer", "2024 – present")
    ...
    add_org_line(doc, "Freelance", "Guayaquil, Ecuador", space_before=6)
    add_role_line(doc, "Fullstack Developer", "2023 – present")
    ...
    add_role_line(doc, "Software Development Intern", "2025  (6 months)")
    ...
    add_org_line(doc, "ApplyJob", "github.com/Mickaell22/ApplyJob", space_before=6)
    add_role_line(doc, "AI-powered automated job application pipeline", "Python · Playwright · LLMs")
    add_bullet(doc, "Automated scraping of 7 job boards, offer matching against candidate profile, and personalized cover letter generation with LLMs.")
    add_bullet(doc, "Implemented headless ATS auto-apply (Workable, Greenhouse, GetOnBrd) using Playwright.")
    ...
    add_skills_line(doc, "Cybersecurity", "Kali Linux (active learning), Nmap, Wireshark")
...
if __name__ == "__main__":
    ...
    es_path = out / "cv_harvard_es.docx"
    en_path = out / "cv_harvard_en.docx"
